...
> **💡 重要ポイント:**  
> このカリキュラムの目的はWebアプリそのものの完成やコーディング技術の習得ではなく、**AI(CURSOR)に作業を依頼し、AIと協働する体験／思考法を身につけること**です。  
> 
> したがって、**手動でコードを書く・修正するのではなく、必ずAIに指示（エージェントやインライン補完など）を出して実装・修正を進めてください**。
> 
