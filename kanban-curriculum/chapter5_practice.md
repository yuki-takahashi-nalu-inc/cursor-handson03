...
補足: **現在のCursor2.0ではPlanモードを使うと段階的な指示を作成することができます。**
...
補足: **現在のCursor2.0ではブラウザ接続を行うことで、Consoleのエラーのコピペや、選択部分をコンテキストに追加することができます。**

## 5.3 Cursor Rulesを活用する
